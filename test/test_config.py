...
class TestBase(TestCase):
    ...
    def test_conditional_includes_from_git_dir(self, rw_dir):
        ...
        with open(path1, "w") as stream:
            stream.write(include_config("gitdir", git_dir_pattern))
        ...
        with open(path1, "w") as stream:
            stream.write(include_config("gitdir", git_dir_pattern.upper()))
        ...
        with open(path1, "w") as stream:
            stream.write(include_config("gitdir/i", git_dir_pattern.upper()))
